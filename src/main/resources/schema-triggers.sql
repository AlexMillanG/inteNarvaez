...
BEGIN
    ...
    VALUES (
               ...
               CONCAT(
                       ...
                       IFNULL(NEW.user_id, 0), ', ''', IFNULL(NEW.birthdate, ''), ''', ''', IFNULL(NEW.email, ''), ''', ''', IFNULL(NEW.first_name, ''),
                       ''', ''', IFNULL(NEW.last_name, ''), ''', ''', IFNULL(NEW.password, ''), ''', ''', IFNULL(NEW.phone, ''),
...
BEGIN
    ...
    VALUES (
               ...
               CONCAT(
                       'INSERT INTO user (user_id, birthdate, email, first_name, last_name, password, phone, rfc, status, surname, temporal_password, last_login) VALUES (',
                       IFNULL(OLD.user_id, 0), ', ''', IFNULL(OLD.birthdate, ''), ''', ''', IFNULL(OLD.email, ''), ''', ''', IFNULL(OLD.first_name, ''),
                       ''', ''', IFNULL(OLD.last_name, ''), ''', ''', IFNULL(OLD.password, ''), ''', ''', IFNULL(OLD.phone, ''),
...
BEGIN
    ...
    VALUES (
               ...
               NOW(),
               CONCAT(
                       'UPDATE user SET birthdate = ''', IFNULL(NEW.birthdate, ''), ''', email = ''', IFNULL(NEW.email, ''),
                       ...
                       ', surname = ''', IFNULL(NEW.surname, ''), ''', temporal_password = ', IFNULL(NEW.temporal_password, 0),
                       ', last_login = ''', IFNULL(NEW.last_login, ''), ''' WHERE user_id = ', IFNULL(OLD.user_id, 0), ';'
               ),
               CONCAT(
                       'UPDATE user SET birthdate = ''', IFNULL(OLD.birthdate, ''), ''', email = ''', IFNULL(OLD.email, ''),
                       ...
                       ', surname = ''', IFNULL(OLD.surname, ''), ''', temporal_password = ', IFNULL(OLD.temporal_password, 0),
...
BEGIN
    ...
    VALUES (
               ...
               CONCAT(
                       ...
                       IFNULL(NEW.id, 0), ', ''', IFNULL(NEW.city, ''), ''', ''', IFNULL(NEW.name, ''), ''', ''', IFNULL(NEW.number, ''),
...
BEGIN
    ...
    VALUES (
               ...
               CONCAT(
                       'INSERT INTO addresses (id, city, name, number, state, status, street, uuid, zip_code, client_id) VALUES (',
                       IFNULL(OLD.id, 0), ', ''', IFNULL(OLD.city, ''), ''', ''', IFNULL(OLD.name, ''), ''', ''', IFNULL(OLD.number, ''),
...
#---Trigguers para Tabla Channel_Categories

-- Triggers para Tabla Channel_Categories

DROP TRIGGER IF EXISTS after_insert_channel_categories;
DELIMITER //
CREATE TRIGGER after_insert_channel_categories
    AFTER INSERT ON channel_categories
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_delete_channel_categories
    AFTER DELETE ON channel_categories
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_update_channel_categories
    AFTER UPDATE ON channel_categories
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_delete_channel_package_channels
    AFTER DELETE ON channel_package_channels
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_update_channel_package_channels
    AFTER UPDATE ON channel_package_channels
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
#---Trigguers para Tabla channel_packages
...
CREATE TRIGGER after_delete_channel_packages
    AFTER DELETE ON channel_packages
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_update_channel_packages
    AFTER UPDATE ON channel_packages
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
#---Trigguers para Tabla contracts
...
#---Trigguers para Tabla logos
DROP TRIGGER IF EXISTS after_insert_logos;
DELIMITER //
...
DROP TRIGGER IF EXISTS after_delete_logos;
DELIMITER //
...
DROP TRIGGER IF EXISTS after_update_logos;
DELIMITER //
CREATE TRIGGER after_update_logos
    AFTER UPDATE ON logos
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
               ...
               CONCAT(
                       ...
                       IFNULL(CONCAT('''', NEW.file_extension, ''''), 'NULL'),
                       ', image = ', IFNULL(CONCAT('''', NEW.image, ''''), 'NULL'),
                       ', uuid = ', IFNULL(CONCAT('''', NEW.uuid, ''''), 'NULL'),
               ...
               CONCAT(
                       'UPDATE logos SET file_extension = ',
                       IFNULL(CONCAT('''', OLD.file_extension, ''''), 'NULL'),
                       ', image = ', IFNULL(CONCAT('''', OLD.image, ''''), 'NULL'),
                       ', uuid = ', IFNULL(CONCAT('''', OLD.uuid, ''''), 'NULL'),
...
BEGIN
    ...
    VALUES (
               ...
               NOW(),
               CONCAT(
                       'INSERT INTO products (id, amount, description, name, speed, uuid, status) VALUES (',
                       IFNULL(NEW.id, 'NULL'), ', ',
                       IFNULL(NEW.amount, 'NULL'), ', ',
                       IFNULL(CONCAT('''', NEW.description, ''''), 'NULL'), ', ',
                       IFNULL(CONCAT('''', NEW.name, ''''), 'NULL'), ', ',
               ...
               CONCAT('DELETE FROM products WHERE id = ', IFNULL(NEW.id, 'NULL'), ';')
           );
END;
//
DELIMITER ;
...
BEGIN
    ...
    VALUES (
               'products',
               NOW(),
               CONCAT('DELETE FROM products WHERE id = ', IFNULL(OLD.id, 'NULL'), ';'),
               CONCAT(
                       'INSERT INTO products (id, amount, description, name, speed, uuid, status) VALUES (',
                       IFNULL(OLD.id, 'NULL'), ', ',
                       IFNULL(OLD.amount, 'NULL'), ', ',
                       IFNULL(CONCAT('''', OLD.description, ''''), 'NULL'), ', ',
                       IFNULL(CONCAT('''', OLD.name, ''''), 'NULL'), ', ',
...
BEGIN
    ...
    VALUES (
               ...
               NOW(),
               CONCAT(
                       'UPDATE products SET amount = ', IFNULL(NEW.amount, 'NULL'),
                       ', description = ', IFNULL(CONCAT('''', NEW.description, ''''), 'NULL'),
                       ', name = ', IFNULL(CONCAT('''', NEW.name, ''''), 'NULL'),
               ...
               CONCAT(
                       'UPDATE products SET amount = ', IFNULL(OLD.amount, 'NULL'),
                       ', description = ', IFNULL(CONCAT('''', OLD.description, ''''), 'NULL'),
                       ', name = ', IFNULL(CONCAT('''', OLD.name, ''''), 'NULL'),
...
CREATE TRIGGER after_delete_sales_packages
    AFTER DELETE ON sales_packages
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_update_sales_packages
    AFTER UPDATE ON sales_packages
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_insert_user_has_roles
    AFTER INSERT ON user_has_roles
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_delete_user_has_roles
    AFTER DELETE ON user_has_roles
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
...
CREATE TRIGGER after_update_user_has_roles
    AFTER UPDATE ON user_has_roles
    FOR EACH ROW
BEGIN
    INSERT INTO bitacora (tabla, fecha, executedSQL, reverseSQL)
    VALUES (
